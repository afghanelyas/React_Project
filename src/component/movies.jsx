...
export default class Movies extends Component {
    ...
    render() {
        ...
        const { pageSize, currentPage, selectedGenres, movies: allMovies, sortColumn } = this.state
        ...
        return (
            ...
            <div className="max-w-lg m-auto mt-10 shadow-md justify-start">
                ...
                <div className="max-w-lg">
                    <p className="text-xl mt-4 bg-slate-100 rounded-sm p-2 ">Showing {filtered.length} movies in the database.</p>
